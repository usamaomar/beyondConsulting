...
class CircularProgressParCustomSmallWidget extends StatefulWidget {
  const CircularProgressParCustomSmallWidget(
...
class _CircularProgressParCustomWidgetState
    extends State<CircularProgressParCustomSmallWidget> {
  @override
