...
import 'update_personals_team_list_dialog_widget.dart'
    show UpdatePersonalsTeamListDialogWidget;
import 'package:flutter/material.dart';

class UpdatePersonalsTeamListDialogModel
    extends FlutterFlowModel<UpdatePersonalsTeamListDialogWidget> {
  ...
  // Stores action output result for [Backend Call - API (GetPersonalsApi)] action in updatePersonalsTeamListDialog widget.
  ApiCallResponse? apiResult4a6;
  // Stores action output result for [Backend Call - API (GetMyTeamApi)] action in updatePersonalsTeamListDialog widget.
