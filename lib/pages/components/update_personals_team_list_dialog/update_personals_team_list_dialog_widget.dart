...
import 'update_personals_team_list_dialog_model.dart';
export 'update_personals_team_list_dialog_model.dart';

class UpdatePersonalsTeamListDialogWidget extends StatefulWidget {
...
class _UpdatePersonalsTeamListDialogWidgetState
    extends State<UpdatePersonalsTeamListDialogWidget> {
  late UpdatePersonalsTeamListDialogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdatePersonalsTeamListDialogModel());
